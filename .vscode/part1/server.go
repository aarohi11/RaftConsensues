...
// Serve method to do RPC call to ConsenusModule
func (s *Server) Serve() {
	s.mu.Lock()
...
// Call method to call the clients
...
// RequestVote to request votes from peers as RPC calls
...
// AppendEntries to append log entries of peers
